...
b_bkg = ROOT.RooRealVar("b_bkg_chebychev_"+CHANNEL+"_GFpreselection","b_bkg",0.3,-1.,1.)
...
#bkgPDF_bernstein  = ROOT.RooProdPdf("bkgPDF_bernstein_GFpreselection_bkg","bkg PDF",ROOT.RooArgList(exp1,bkgPDF_Landau))

#Input file and tree ---------------------------------------------------------------
fileInput = ROOT.TFile("histos/latest_production/histos_SR_preselection_Data.root")
fileInput.cd()
...
multipdf = ROOT.RooMultiPdf("multipdf_"+CHANNEL+"_GFpreselection_bkg","All Pdfs",cat,mypdfs)
