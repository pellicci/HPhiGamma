...
dCB_width_ggH = ROOT.RooRealVar("dCB_width_" + CHANNEL + "_GFpreselection_ggH", "Double CB width", 1., 1., 2.)
dCB_aL_ggH = ROOT.RooRealVar("dCB_aL_" + CHANNEL + "_GFpreselection_ggH", "Double CB alpha left", 1., 1., 2.)
...
if isRhoGammaAnalysis:
    dCB_pole_ggH = ROOT.RooRealVar("dCB_pole_" + CHANNEL + "_GFpreselection_ggH", "Double CB pole", 125., 120., 130.)
    dCB_width_ggH = ROOT.RooRealVar("dCB_width_" + CHANNEL + "_GFpreselection_ggH", "Double CB width", 1., 0., 20.)
...
signalPDF_ggH = ROOT.RooDoubleCBFast(
    "crystal_ball_" + CHANNEL + "_GFpreselection_ggH", "Double Crystal Ball", mass, dCB_pole_ggH, dCB_width_ggH,
    dCB_aL_ggH, dCB_nL_ggH, dCB_aR_ggH, dCB_nR_ggH)
signalPDF_VBF = ROOT.RooDoubleCBFast(
    "crystal_ball_" + CHANNEL + "_GFpreselection_VBF", "Double Crystal Ball", mass, dCB_pole_VBF, dCB_width_VBF,
    dCB_aL_VBF, dCB_nL_VBF, dCB_aR_VBF, dCB_nR_VBF)
...
c1.SetTitle("")
if includeResiduals:
    c1.Divide(1, 2)  # Divide canvas into two pads: 1x2 grid
...
if includeResiduals:
    ...
    residuals.GetXaxis().SetTitleSize(0.12)
