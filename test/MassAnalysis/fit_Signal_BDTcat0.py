...
dCB_width_ggH = ROOT.RooRealVar("dCB_width_"+CHANNEL+"_GFcat_bdt0_ggH", "Double CB width",1.,0.,2.)
...
if includeResiduals:
	c1.SaveAs("/eos/user/g/gumoret/www/latest_production/massanalysis_latest_production/fitsignal_" + CHANNEL + "_BDTcat0_ggH_resid.pdf")
	c1.SaveAs("/eos/user/g/gumoret/www/latest_production/massanalysis_latest_production/fitsignal_" + CHANNEL + "_BDTcat0_ggH_resid.png")
else:
...
if includeResiduals:
	c2.SaveAs("/eos/user/g/gumoret/www/latest_production/massanalysis_latest_production/fitsignal_" + CHANNEL + "_BDTcat0_VBF_resid.pdf")
	c2.SaveAs("/eos/user/g/gumoret/www/latest_production/massanalysis_latest_production/fitsignal_" + CHANNEL + "_BDTcat0_VBF_resid.png")
else:
