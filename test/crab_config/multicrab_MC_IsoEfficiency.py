...
config.General.requestName = 'HPhiGammaIsoEfficiencyAnalysis_DY10to50'
config.Data.unitsPerJob = 5
...
config.General.requestName = 'HPhiGammaIsoEfficiencyAnalysis_DY50' #Requires FileBased splitting
config.Data.unitsPerJob = 5
