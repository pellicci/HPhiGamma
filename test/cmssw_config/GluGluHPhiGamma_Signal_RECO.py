...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:HPhiGamma_signal_HLT.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HPhiGamma_signal_RECO.root'),
