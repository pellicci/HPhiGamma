...
# with command line options: step1 --filein file:HPhiGamma_signal_RECO.root --fileout file:HPhiGamma_signal_MINIAOD.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 102X_upgrade2018_realistic_v15 --step PAT --geometry DB:Extended --era Run2_2018 --python_filename GluGluHPhiGamma_Signal_MINIAOD_2.py --no_exec -n 5
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:HPhiGamma_signal_RECO.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HPhiGamma_signal_MINIAOD.root'),
