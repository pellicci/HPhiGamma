...
process.TFileService = cms.Service("TFileService",
   fileName = cms.string("HPhiGammaTwoProngsTriggerAnalysis_output.root")
)

process.load("HiggsAnalysis.HPhiGamma.HPhiGammaTwoProngsTriggerAnalysis_cfi")
process.HPhiGammaTwoProngsTriggerAnalysis.runningOnData = options.runningOnData

# Apply JEC to both MC and data
#process.HPhiGammaTwoProngsTriggerAnalysis.slimmedJets = cms.InputTag("updatedPatJetsUpdatedJEC")
...
process.seq = cms.Path(process.HPhiGammaTwoProngsTriggerAnalysis)
